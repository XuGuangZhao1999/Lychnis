...
class AnimationPanelBinding : public CefMessageRouterBrowserSide::Handler
{
public:
    AnimationPanelBinding();
    virtual ~AnimationPanelBinding() {}
...
private:
    FunctionFactory<AnimationPanelBinding> tasks;
    DISALLOW_COPY_AND_ASSIGN(AnimationPanelBinding);
};
